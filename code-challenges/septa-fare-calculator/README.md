...
Thank you for the opportunity to work on this code challenge. I kept myself to 60 minutes and
unfortunately was only able to set up the form and the ajax call in the time allowed without being
able to produce functionality. I consider myself a junior full-stack developer so there are still
many tasks where I need to check documentation.
